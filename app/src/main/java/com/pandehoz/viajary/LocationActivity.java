...
public class LocationActivity extends ActionBarActivity implements
    ...
    private LatLng initialLatLong = null;
    ...
    private static final int ACTION_TAKE_VIDEO = 4;
    ...
    private String mTripTitle = "Dummy Trip";
    ...
    private GoogleMap.OnMyLocationChangeListener myLocationChangeListener = new GoogleMap.OnMyLocationChangeListener() {
        ...
        public void onMyLocationChange(Location location) {
            ...
            if(initialLatLong == null){
                initialLatLong = new LatLng(location.getLatitude(), location.getLongitude());
                markers.add(mMap.addMarker(new MarkerOptions().position(loc)));
                if(mMap != null){
                    mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(loc, 16.0f));
                }
            }
            else if(loc.latitude == initialLatLong.latitude && loc.longitude == initialLatLong.longitude){
                return;
            }
    ...
    Button.OnClickListener mRecordAudioListener =
            new Button.OnClickListener() {
    ...
    Button.OnClickListener mPlayAudioListener =
            new Button.OnClickListener() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button picBtn = (Button) findViewById(R.id.btn_take_photo);

        mRecordButton = (Button) findViewById(R.id.record_button);
        mRecordButton.setOnClickListener(mRecordAudioListener);
    ...
    protected void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putBoolean(VIDEOVIEW_VISIBILITY_STORAGE_KEY, (mVideoUri != null) );
